...
export default function QuotesModel({ show, handleClose, data }) {
  ...
  return (
    <>
      <AdditonalDetails
        showModel={detailsModel}
        handleCloseModel={detailsModelClose}
      />
      <Modal
        show={show}
        onHide={handleClose}
                        ...
                        <tr className="table-row">
                          ...
                          <td>
                            ...
                            >
                              <a
                                title={
                                  e?.product_variant?.products?.product_name
                                }
